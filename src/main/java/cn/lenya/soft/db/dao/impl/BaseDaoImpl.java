...
public abstract class BaseDaoImpl extends Base implements IBaseDao {
	...
	public abstract <T> T getObject(String sql, Object[] args, Class<T> clazz,
	...
	public abstract <T> Map<String, T> getObjectMap(String sql, Object[] args,Class<?> clazz, Map<String, Object> orm)throws Exception;
	...
	public abstract <T> List<T> getList(String sql, Object[] args, Class<T> clazz,Map<String, Object> orm) throws Exception;
