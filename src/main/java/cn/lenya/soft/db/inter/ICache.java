...
public interface ICache {
	...
	<T> void saveWithExpired(String key, T object, int expiredSeconds);
	...
	Boolean setLock(String lockId,String requestId);
	
	Boolean lock(String lockId,String requestId,Long validTime,TimeUnit timeUnit);
	
	Boolean unLock(String lockId,String requestId);
}